...
namespace Optera.DTOs.Customer
{
    public class GetCustomerDto
    {
        ...
        public ICollection<GetCustomerIdentificationDto>? CustomerIdentifications { get; set; }
        public ICollection<GetCustomerContactPersonDto>? CustomerContactPersons { get; set; }
    }
}
